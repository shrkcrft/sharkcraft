...
This file briefs Codex (and any agent that loads `AGENTS.md`) on the
...
packages/
  ...
  importer/     AGENTS.md / AGENTS.md / .cursor/rules parsers
...
`AGENTS.md` (this file) is included in the seed; editing it changes
