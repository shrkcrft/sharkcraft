...
function readme(scenarios: readonly IDemoScript[]): string {
  ...
  lines.push('');
  lines.push('Generated by SharkCraft (demo package). Drop this folder onto another machine,');
...
function combinedDemoScript(scenarios: readonly IDemoScript[]): string {
  ...
  lines.push('# SharkCraft demo bundle — generated by SharkCraft (demo package).');
