...
function ghaPrReview(bun: string): string {
  ...
  lines.push('# Generated by SharkCraft (demo PR-review workflow, github-actions).');
...
function gitlabPrReview(bun: string): string {
  ...
  lines.push('# Generated by SharkCraft (demo PR-review workflow, gitlab).');
...
function bitbucketPrReview(bun: string): string {
  const lines: string[] = [];
  lines.push('# SharkCraft demo PR review pipeline.');
  lines.push('# Generated by SharkCraft (demo PR-review workflow, bitbucket).');
