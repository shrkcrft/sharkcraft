...
import { nestRuleSnippet } from './r26-snippets.ts';

// ─── Architecture: modules, controllers, services, repos ──────────────────

export const NEST11_THIN_CONTROLLERS = nestRuleSnippet({
...
export const NEST11_SERVICE_OWNS_DOMAIN = nestRuleSnippet({
...
export const NEST11_MODULE_PER_FEATURE = nestRuleSnippet({
...
export const NEST11_MODULE_PUBLIC_API = nestRuleSnippet({
...
export const NEST11_NO_CIRCULAR_MODULES = nestRuleSnippet({
...
export const NEST11_DTO_AT_BOUNDARY = nestRuleSnippet({
...
export const NEST11_GLOBAL_VALIDATION_PIPE = nestRuleSnippet({
...
export const NEST11_CLASS_VALIDATOR_DTO = nestRuleSnippet({
...
export const NEST11_REQUEST_RESPONSE_DTOS = nestRuleSnippet({
...
export const NEST11_SWAGGER_DECORATORS = nestRuleSnippet({
...
export const NEST11_LIFECYCLE_HOOKS = nestRuleSnippet({
...
export const NEST11_ENABLE_SHUTDOWN_HOOKS = nestRuleSnippet({
...
export const NEST11_ASYNC_PROVIDERS = nestRuleSnippet({
...
export const NEST11_FASTIFY_ADAPTER = nestRuleSnippet({
...
export const NEST11_CACHE_MANAGER = nestRuleSnippet({
...
export const NEST11_THROTTLER = nestRuleSnippet({
  id: 'nest11.throttler',
...
export const NEST11_PAGINATION_BY_DEFAULT = nestRuleSnippet({
...
export const NEST11_HELMET = nestRuleSnippet({
  id: 'nest11.helmet',
...
export const NEST11_EXPLICIT_CORS = nestRuleSnippet({
...
export const NEST11_JWT_GUARDS = nestRuleSnippet({
...
export const NEST11_NO_SECRETS_IN_CODE = nestRuleSnippet({
...
export const NEST11_TRUST_PROXY_AWARE = nestRuleSnippet({
...
export const NEST11_LOGGER_WITH_CONTEXT = nestRuleSnippet({
...
export const NEST11_STRUCTURED_LOGS = nestRuleSnippet({
...
export const NEST11_NO_LOG_SECRETS = nestRuleSnippet({
...
export const NEST11_TERMINUS_HEALTH = nestRuleSnippet({
...
export const NEST11_TESTING_MODULE = nestRuleSnippet({
...
export const NEST11_E2E_SUPERTEST = nestRuleSnippet({
...
export const NEST11_TEST_FILE_LAYOUT = nestRuleSnippet({
...
export const NEST11_API_VERSIONING = nestRuleSnippet({
...
export const NEST11_NO_QUERY_IN_CONTROLLER = nestRuleSnippet({
